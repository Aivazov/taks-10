...
})({"gbX9I":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "440531bcd553cda1";
"use strict";
...
},{}],"ltS0o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _stylesCss = require("../css/styles.css");
// import { Notify } from 'notiflix/build/notiflix-notify-aio';
var _fetchCountries = require("./helpers/fetchCountries");
...
function fetchIntoInput(e) {
    ...
    (0, _fetchCountriesDefault.default)(searchRequest).then((data)=>{
        if (data.length > 4) Notiflix.Notify.info("Too many matches found. Please enter a more specific name.");
        else if (data.length > 1) data.map((m)=>{
...
searchForm.addEventListener("submit", (e)=>{
    ...
    (0, _fetchCountriesDefault.default)(searchRequest).then(testRender);
    searchForm.reset();
});
...
function renderUser(data) {
  ...
  <div>${data.location ? `<div>${data.location}</div>` : "No location was given"}</div>
  `;
}

},{"./helpers/fetchCountries":"dh0yK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../css/styles.css":"1CY4s"}],"dh0yK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"1CY4s":[function() {},{}]},["gbX9I","ltS0o"], "ltS0o", "parcelRequire207a")

//# sourceMappingURL=practice.d553cda1.js.map
